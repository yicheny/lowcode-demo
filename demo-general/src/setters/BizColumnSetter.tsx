...
function useMockOption() {
    return useMemo(() => {
        return [
            ...
            {label: "账户余额", value: "账户余额", option: {dataIndex: "cashAmt", align: "right",width:100, cell:format}},
            {label: "授信额度", value: "授信额度", option: {dataIndex: "creditLimit", align: "right",width:100, cell:format}},
            {label: "盯市金额", value: '盯市金额', option: {dataIndex: "toMarketAmt", align: "right",width:100, cell:format}},
            {label: "总维持保证金", value: '总维持保证金', option: {dataIndex: "marginAmt", align: "right",width:100, cell:format}},
